...
- В конце последней рекомендации добавь ссылку на YouTube-видео для прокачки скилла в формате: 🎓 Видео для прокачки: https://www.youtube.com/results?search_query=тема_поиска
- Выбери тему поиска по видео в зависимости от проблемы: "эмпатия в общении с клиентами" для нехватки сочувствия, "деловая переписка с клиентами" для грубости, "работа с возражениями клиентов" для игнорирования
