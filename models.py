...
CRITERIA = [
    ...
    },
    {
        ...
        "descriptions": {
            ...
            3: "Вопрос пользователя решён не полностью, дан ответ не на все вопросы",
    ...
    },
    {
        ...
        "descriptions": {
            1: "Грубость",
            3: "Были попытки урегулирования ситуации, но не извинились, если пользователь столкнулся с проблемой по вине нашей системы (не сторонних программ или организаций)",
